...
if (hamburger && navMenu) {
    ...
    document.addEventListener("click", (e) => {
        // Si on clique hors du menu et hors du burger, on ferme
...
const menuData = {
    ...
    drinks: {
        ...
        items: [
            ...
            { category: "sodas", name: "Eaux Minérales", desc: "Sidi Ali, Oulmes, San Pellegrino", price: "15-25 DH", image: "images/menuEau.jpg" }
        ],
    },
    dessert: {
        categories: [
